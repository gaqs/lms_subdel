					...
					<div class="col-md-12">
						...
						<div class="tab-content" id="courses_tabs">
							<div class="tab-pane show active" id="basic_tab" role="tabpanel" aria-labelledby="basic_tab" tabindex="0">
								...
								<div class="row">
									<input type="hidden" name="id" value="<?= old('id', $curso->id ?? '') ?>">
									...
									<div class="col-md-6 mb-3">
										<label for="input" class="form-label">Duracion</label>
										<input type="number" class="form-control" id="input-duration" name="duration" value="<?= $course->duration ?? '' ?>">
									</div>
									...
									<div class="col-md-12 mb-3">
										...
										<?php if (!empty($course->image)): ?>
											<div class="file_container position-relative mt-3" style="width:30%;">
												<a href="<?= base_url('admin/blogs/delete_image?id=' . $course->id . '&imagename=' . $course->image); ?>" class="text-danger position-absolute end-0 delete_button" onclick="return confirm('¿Está seguro de querer eliminar el video?');">

				...
				<div class="card-body" id="module_container">
					<div class="d-flex mb-4" id="module_header">
						...
						<div id="module_buttons">
							<a href="<?= base_url('admin/lesson/new?module_id').$m->id ?>" class="btn btn-outline-success" id="create_lesson">Agregar Lección <i class="bi bi-plus"></i></a>
							<div id="module_options" class="dropdown d-inline-block">
								...
								<ul class="dropdown-menu dropdown-menu-end">
									<li><a href="#editar" class="dropdown-item" id="edit_module" data-module-id="<?= $m->id ?>">Editar</a></li>
						...
						<div class="card text-bg-light">
							<div class="card-body d-flex p-4">
								...
								<div id="lesson_options" class="me-1 dropdown d-inline-block">
									...
									<ul class="dropdown-menu dropdown-menu-end">
										<li><a href="#editar" class="dropdown-item">Editar</a></li>
										<li>
